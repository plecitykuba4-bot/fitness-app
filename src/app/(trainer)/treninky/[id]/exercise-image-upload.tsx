...
export function ExerciseImageUpload({ exerciseId, imageUrl }: { exerciseId: string; imageUrl?: string }) {
  ...
  return (
    <div className="mt-3 rounded-[var(--radius-button)] border border-border bg-surface p-3">
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1"><p className="font-semibold">Fotka techniky</p><p className="text-sm text-muted-foreground">Nahrajete přímo z galerie v iPhonu.</p></div>
